...
$(document).ready(function() {
    ...
    if($('.countdowntimer').length){
        // var enddate()
        $('.countdowntimer').each(function(timer){
            // $this = $(this);
            var EndDate =$(this).attr("data-countdown");
            ...
            var remaining = date.getTime() - StartDate.getTime();
            var countDownTime = remaining/1000;

            $(this).FlipClock(countDownTime,{
