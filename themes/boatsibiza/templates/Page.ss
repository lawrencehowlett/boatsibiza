...
<!-- CSS
	...
	<link type="text/css" id="colors" rel="stylesheet" href="$Themedir/css/yellow.css">
	<link type="text/css" rel="stylesheet" href="$Themedir/css/custom.css">
	<link rel="stylesheet" href="$Themedir/js-plugin/FlipClock/compiled/flipclock.css">
	<!--[if lt IE 9]><script src="http://html5shim.googlecode.com/svn/trunk/html5.js"></script> <![endif]-->
	<script src="$Themedir/js/modernizr-2.6.1.min.js"></script>
<!-- Favicons
	================================================== -->
	<link rel="shortcut icon" href="$Themedir/images/favico.png">
	...
	<script src="//load.sumome.com/" data-sumo-site-id="ce90ce9550d4f751a5ec74c168f5feace6187668f45ba05113a29404a2845013" async></script>
</head>
<body class="header1" id="">
<!-- Primary Page Layout 
	================================================== -->
	<!-- globalWrapper -->
...
<!-- End Document 
	...
	<script src="$Themedir/js-plugin/FlipClock/compiled/flipclock.min.js"></script>
	<!-- Custom  -->
